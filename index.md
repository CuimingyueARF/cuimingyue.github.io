...
<div class="publication">
    ...
    <cite>Engineering Applications of Artificial Intelligence (EAAI)</cite>, 2025, 160: 111901-111914.
    <span class="ccf-tag">(中科院一区, IF：8, </span>
        <span class="publication-links">
    ...
    <div style="text-align: center;">
        <div style="background: #f8f9fa; padding: 8px 8px 4px 8px; border-radius: 4px; height: 100%;">
            <img src="./picture/工业机器人.jpg" alt="工业机器人"
                 style="width: 100%; height: 140px; object-fit: cover; border-radius: 3px; margin-bottom: 4px;">
            <h4 style="margin: 0 0 2px; font-size: 0.9em; font-weight: 500;">工业机器人</h4>
        </div>
    </div>
    ...
    <div style="text-align: center;">
        <div style="background: #f8f9fa; padding: 8px 8px 4px 8px; border-radius: 4px; height: 100%;">
            <img src="./picture/无人车.png" alt="无人车"
                 style="width: 100%; height: 140px; object-fit: cover; border-radius: 3px; margin-bottom: 4px;">
            <h4 style="margin: 0 0 2px; font-size: 0.9em; font-weight: 500;">无人车</h4>
        </div>
    </div>
    ...
    <div style="text-align: center;">
        <div style="background: #f8f9fa; padding: 8px 8px 4px 8px; border-radius: 4px; height: 100%;">
            <img src="./picture/无人船.gif" alt="无人船"
                 style="width: 100%; height: 140px; object-fit: cover; border-radius: 3px; margin-bottom: 4px;">
            <h4 style="margin: 0 0 2px; font-size: 0.9em; font-weight: 500;">无人船</h4>
        </div>
    </div>
    ...
    <div style="text-align: center;">
        <div style="background: #f8f9fa; padding: 8px 8px 4px 8px; border-radius: 4px; height: 100%;">
            <img src="./picture/仿生蝴蝶机器人.jpg" alt="仿生蝴蝶机器人"
                 style="width: 100%; height: 140px; object-fit: cover; border-radius: 3px; margin-bottom: 4px;">
            <h4 style="margin: 0 0 2px; font-size: 0.9em; font-weight: 500;">仿生蝴蝶机器人</h4>
        </div>
    </div>
